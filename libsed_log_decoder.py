...
class SedcliMessageViewer:
    ...
    def print_ComPacketFormat_Payload_PacketFormatPayload_DataSubPacketPayload(self, message):
        ...
        if _token == TcgStorageBinaryLogParser.DataControlDataSubPacketFormat.TokenEnum.call_token:
            self.print_ComPacketFormat_Payload_PacketFormatPayload_DataSubPacketPayloadCallToken(message)
        elif _token == TcgStorageBinaryLogParser.DataControlDataSubPacketFormat.TokenEnum.start_list_token:
    ...
    def print_Discovery_Response_Data_generic(self, feature_descriptor, is_last_descriptor=False):
        ...
        if self.verbose == 1:
            ...
            self.custom_printer.print(f"      Feature Code: {Fore.GREEN}{feature_descriptor.feature_code.name}{Style.RESET_ALL} ({feature_descriptor.version}, {feature_descriptor.feature_code_length})", block_type='mid')
            ...
            _descriptor_data_hex = SedcliMessageViewer.format_hex(feature_descriptor._raw_descriptor_data, 23)
            self.custom_printer.print(f"      Feature Code: {Fore.GREEN}{feature_descriptor.feature_code.name}{Style.RESET_ALL} (Ver={feature_descriptor.version}, Len={feature_descriptor.feature_code_length})", block_type='mid')
            if feature_descriptor.feature_code_length <= 16:
                self.custom_printer.print(f"      Descriptor Data: ", block_type=block_type, end_line=False)
                self.print_multilines(_descriptor_data_hex, Fore.CYAN, 'none_second_part', 'end')
            else:
            ...
            self.custom_printer.print(f"      Feature Code: {Fore.GREEN}{feature_descriptor.feature_code.name}{Style.RESET_ALL}", block_type='mid')
    ...
    def print_Discovery_Response_Data_tper_feature(self, feature_descriptor, is_last_descriptor=False):
        ...
        if self.verbose == 1:
            ...
            self.custom_printer.print(f"      {Fore.GREEN}{feature_descriptor.feature_code.name}{Style.RESET_ALL} (Ver={feature_descriptor.version}, Len={feature_descriptor.feature_code_length})", block_type='mid')
    ...
    def print_Discovery_Response_Data_Geometry_reporting_feature(self, feature_descriptor, is_last_descriptor=False):
        ...
        if self.verbose == 1:
            ...
            self.custom_printer.print(f"        Lowest aligned LBA    : {feature_descriptor.descriptor_data.lowest_aligned_lba}", block_type='mid')

    def print_Discovery_Response_Data(self, message):
        featureDescriptorFunctionMap= {
            TcgStorageBinaryLogParser.FeatureDescriptorType.FeatureCodeEnum.tper_feature:    self.print_Discovery_Response_Data_tper_feature,
            TcgStorageBinaryLogParser.FeatureDescriptorType.FeatureCodeEnum.locking_feature: self.print_Discovery_Response_Data_locking_feature,
            TcgStorageBinaryLogParser.FeatureDescriptorType.FeatureCodeEnum.geometry_reporting_feature: self.print_Discovery_Response_Data_Geometry_reporting_feature,
            TcgStorageBinaryLogParser.FeatureDescriptorType.FeatureCodeEnum.opal_ssc_v1_feature: self.print_Discovery_Response_Data_generic,
            TcgStorageBinaryLogParser.FeatureDescriptorType.FeatureCodeEnum.single_user_mode_feature: self.print_Discovery_Response_Data_generic,
            TcgStorageBinaryLogParser.FeatureDescriptorType.FeatureCodeEnum.additional_datastore_tables_feature: self.print_Discovery_Response_Data_generic,
            TcgStorageBinaryLogParser.FeatureDescriptorType.FeatureCodeEnum.opal_ssc_v2_feature: self.print_Discovery_Response_Data_generic,
            TcgStorageBinaryLogParser.FeatureDescriptorType.FeatureCodeEnum.opalite_ssc_feature: self.print_Discovery_Response_Data_generic,
            TcgStorageBinaryLogParser.FeatureDescriptorType.FeatureCodeEnum.pyrite_ssc_v1_feature: self.print_Discovery_Response_Data_generic,
            TcgStorageBinaryLogParser.FeatureDescriptorType.FeatureCodeEnum.pyrite_ssc_v2_feature: self.print_Discovery_Response_Data_generic,
            TcgStorageBinaryLogParser.FeatureDescriptorType.FeatureCodeEnum.ruby_ssc_v1_feature: self.print_Discovery_Response_Data_generic,
            TcgStorageBinaryLogParser.FeatureDescriptorType.FeatureCodeEnum.key_per_io_ssc_v1_feature: self.print_Discovery_Response_Data_generic,
            TcgStorageBinaryLogParser.FeatureDescriptorType.FeatureCodeEnum.block_sid_authentication_feature: self.print_Discovery_Response_Data_generic,
            TcgStorageBinaryLogParser.FeatureDescriptorType.FeatureCodeEnum.configurable_namespace_locking_feature: self.print_Discovery_Response_Data_generic,
            TcgStorageBinaryLogParser.FeatureDescriptorType.FeatureCodeEnum.data_removal_mechanism_feature: self.print_Discovery_Response_Data_generic,
            TcgStorageBinaryLogParser.FeatureDescriptorType.FeatureCodeEnum.shadow_mbr_for_multiple_namespaces_feature_descriptor_feature: self.print_Discovery_Response_Data_generic,
        }
