...
class TcgStorageBinaryLogParser(KaitaiStruct):
    ...
    def _read(self):
        ...
        while not self._io.is_eof():
            self.opal_command.append(TcgStorageBinaryLogParser.OpalCommandType(self._io, self, self._root))
            i += 1
    ...
    class FeatureDescriptorListType(KaitaiStruct):
        ...
        def _read(self):
            ...
            i = 0
            while not self._io.is_eof():
                self.feature_descriptor.append(TcgStorageBinaryLogParser.FeatureDescriptorType(self._io, self, self._root))
                i += 1
    ...
    class FeatureDescriptorDataRemovalMechanismType(KaitaiStruct):
        ...
        @property
        def data_removal_time_format_for_it_5(self):
            if hasattr(self, '_m_data_removal_time_format_for_it_5'):
                return self._m_data_removal_time_format_for_it_5

            self._m_data_removal_time_format_for_it_5 = ((self.byte_4 & 32) >> 5)
            return getattr(self, '_m_data_removal_time_format_for_it_5', None)

        @property
        def data_removal_time_format_for_it_2(self):
            if hasattr(self, '_m_data_removal_time_format_for_it_2'):
                return self._m_data_removal_time_format_for_it_2

            self._m_data_removal_time_format_for_it_2 = ((self.byte_4 & 4) >> 2)
            return getattr(self, '_m_data_removal_time_format_for_it_2', None)
        ...
        @property
        def data_removal_time_format_for_it_0(self):
            if hasattr(self, '_m_data_removal_time_format_for_it_0'):
                return self._m_data_removal_time_format_for_it_0

            self._m_data_removal_time_format_for_it_0 = ((self.byte_4 & 1) >> 0)
            return getattr(self, '_m_data_removal_time_format_for_it_0', None)

        @property
        def data_removal_time_format_for_it_1(self):
            if hasattr(self, '_m_data_removal_time_format_for_it_1'):
                return self._m_data_removal_time_format_for_it_1

            self._m_data_removal_time_format_for_it_1 = ((self.byte_4 & 2) >> 1)
            return getattr(self, '_m_data_removal_time_format_for_it_1', None)
    ...
    class PacketFormat(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.packet_format_payload = TcgStorageBinaryLogParser.DataSubPacketFormat(_io__raw_packet_format_payload, self, self._root)
    ...
    class OpalCommandType(KaitaiStruct):
        ...
        def _read(self):
            self.nvme_header = TcgStorageBinaryLogParser.NvmeHeaderType(self._io, self, self._root)
            _on = self.nvme_header.com_id
            if _on == 1:
                self.comid_packets = TcgStorageBinaryLogParser.Level0DiscoveryResponseData(self._io, self, self._root)
            elif _on == 2048:
                self.comid_packets = TcgStorageBinaryLogParser.ComPacketFormat(self._io, self, self._root)
            else:
                self.comid_packets = TcgStorageBinaryLogParser.ComPacketFormat(self._io, self, self._root)
    ...
    class CallTokenPayload(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.invoking_uid = KaitaiStream.resolve_enum(TcgStorageBinaryLogParser.CallTokenPayload.InvokingUidEnum, self._io.read_u8be())
            self.token_header2 = self._io.read_u1()
            self.method_uid = KaitaiStream.resolve_enum(TcgStorageBinaryLogParser.CallTokenPayload.MethodUidEnum, self._io.read_u8be())
    ...
    class NvmeHeaderType(KaitaiStruct):
        ...
        def _read(self):
            self.nvme_command = KaitaiStream.resolve_enum(TcgStorageBinaryLogParser.NvmeHeaderType.NvmeCommandEnum, self._io.read_u1())
    ...
    class ComPacketFormat(KaitaiStruct):
        ...
        def _read(self):
            ...
            if self.payload_length > 0:
                ...
                self.payload = TcgStorageBinaryLogParser.PacketFormat(_io__raw_payload, self, self._root)
    ...
    class FeatureDescriptorType(KaitaiStruct):
        ...
        def _read(self):
            self.feature_code = KaitaiStream.resolve_enum(TcgStorageBinaryLogParser.FeatureDescriptorType.FeatureCodeEnum, self._io.read_u2be())
            self.byte_3 = self._io.read_u1()
            self.feature_code_length = self._io.read_u1()
            _on = self.feature_code
            if _on == TcgStorageBinaryLogParser.FeatureDescriptorType.FeatureCodeEnum.pyrite_ssc_v1_feature:
                ...
                self.descriptor_data = TcgStorageBinaryLogParser.FeatureDescriptorPyriteSscV1Type(_io__raw_descriptor_data, self, self._root)
            elif _on == TcgStorageBinaryLogParser.FeatureDescriptorType.FeatureCodeEnum.block_sid_authentication_feature:
                self._raw_descriptor_data = self._io.read_bytes(self.feature_code_length)
                _io__raw_descriptor_data = KaitaiStream(BytesIO(self._raw_descriptor_data))
                self.descriptor_data = TcgStorageBinaryLogParser.FeatureDescriptorBlockSidAuthenticationType(_io__raw_descriptor_data, self, self._root)
            elif _on == TcgStorageBinaryLogParser.FeatureDescriptorType.FeatureCodeEnum.pyrite_ssc_v2_feature:
                self._raw_descriptor_data = self._io.read_bytes(self.feature_code_length)
                _io__raw_descriptor_data = KaitaiStream(BytesIO(self._raw_descriptor_data))
                self.descriptor_data = TcgStorageBinaryLogParser.FeatureDescriptorPyriteSscV2Type(_io__raw_descriptor_data, self, self._root)
            elif _on == TcgStorageBinaryLogParser.FeatureDescriptorType.FeatureCodeEnum.locking_feature:
                self._raw_descriptor_data = self._io.read_bytes(self.feature_code_length)
                _io__raw_descriptor_data = KaitaiStream(BytesIO(self._raw_descriptor_data))
                self.descriptor_data = TcgStorageBinaryLogParser.FeatureDescriptorLockingType(_io__raw_descriptor_data, self, self._root)
            elif _on == TcgStorageBinaryLogParser.FeatureDescriptorType.FeatureCodeEnum.tper_feature:
                self._raw_descriptor_data = self._io.read_bytes(self.feature_code_length)
                _io__raw_descriptor_data = KaitaiStream(BytesIO(self._raw_descriptor_data))
                self.descriptor_data = TcgStorageBinaryLogParser.FeatureDescriptorTperType(_io__raw_descriptor_data, self, self._root)
            elif _on == TcgStorageBinaryLogParser.FeatureDescriptorType.FeatureCodeEnum.ruby_ssc_v1_feature:
                self._raw_descriptor_data = self._io.read_bytes(self.feature_code_length)
                _io__raw_descriptor_data = KaitaiStream(BytesIO(self._raw_descriptor_data))
                self.descriptor_data = TcgStorageBinaryLogParser.FeatureDescriptorRubySscV1Type(_io__raw_descriptor_data, self, self._root)
            elif _on == TcgStorageBinaryLogParser.FeatureDescriptorType.FeatureCodeEnum.data_removal_mechanism_feature:
                self._raw_descriptor_data = self._io.read_bytes(self.feature_code_length)
                _io__raw_descriptor_data = KaitaiStream(BytesIO(self._raw_descriptor_data))
                self.descriptor_data = TcgStorageBinaryLogParser.FeatureDescriptorDataRemovalMechanismType(_io__raw_descriptor_data, self, self._root)
            elif _on == TcgStorageBinaryLogParser.FeatureDescriptorType.FeatureCodeEnum.opal_ssc_v2_feature:
                self._raw_descriptor_data = self._io.read_bytes(self.feature_code_length)
                _io__raw_descriptor_data = KaitaiStream(BytesIO(self._raw_descriptor_data))
                self.descriptor_data = TcgStorageBinaryLogParser.FeatureDescriptorOpalSscV2Type(_io__raw_descriptor_data, self, self._root)
            elif _on == TcgStorageBinaryLogParser.FeatureDescriptorType.FeatureCodeEnum.single_user_mode_feature:
                self._raw_descriptor_data = self._io.read_bytes(self.feature_code_length)
                _io__raw_descriptor_data = KaitaiStream(BytesIO(self._raw_descriptor_data))
                self.descriptor_data = TcgStorageBinaryLogParser.FeatureDescriptorSingleUserModeType(_io__raw_descriptor_data, self, self._root)
            elif _on == TcgStorageBinaryLogParser.FeatureDescriptorType.FeatureCodeEnum.opal_ssc_v1_feature:
                self._raw_descriptor_data = self._io.read_bytes(self.feature_code_length)
                _io__raw_descriptor_data = KaitaiStream(BytesIO(self._raw_descriptor_data))
                self.descriptor_data = TcgStorageBinaryLogParser.FeatureDescriptorOpalSscV1Type(_io__raw_descriptor_data, self, self._root)
            elif _on == TcgStorageBinaryLogParser.FeatureDescriptorType.FeatureCodeEnum.opalite_ssc_feature:
                self._raw_descriptor_data = self._io.read_bytes(self.feature_code_length)
                _io__raw_descriptor_data = KaitaiStream(BytesIO(self._raw_descriptor_data))
                self.descriptor_data = TcgStorageBinaryLogParser.FeatureDescriptorOpaliteSscType(_io__raw_descriptor_data, self, self._root)
            elif _on == TcgStorageBinaryLogParser.FeatureDescriptorType.FeatureCodeEnum.configurable_namespace_locking_feature:
                self._raw_descriptor_data = self._io.read_bytes(self.feature_code_length)
                _io__raw_descriptor_data = KaitaiStream(BytesIO(self._raw_descriptor_data))
                self.descriptor_data = TcgStorageBinaryLogParser.FeatureDescriptorConfigurableNamespaceLockingType(_io__raw_descriptor_data, self, self._root)
            elif _on == TcgStorageBinaryLogParser.FeatureDescriptorType.FeatureCodeEnum.geometry_reporting_feature:
                self._raw_descriptor_data = self._io.read_bytes(self.feature_code_length)
                _io__raw_descriptor_data = KaitaiStream(BytesIO(self._raw_descriptor_data))
                self.descriptor_data = TcgStorageBinaryLogParser.FeatureDescriptorGeometryReportingType(_io__raw_descriptor_data, self, self._root)
            elif _on == TcgStorageBinaryLogParser.FeatureDescriptorType.FeatureCodeEnum.additional_datastore_tables_feature:
                self._raw_descriptor_data = self._io.read_bytes(self.feature_code_length)
                _io__raw_descriptor_data = KaitaiStream(BytesIO(self._raw_descriptor_data))
                self.descriptor_data = TcgStorageBinaryLogParser.FeatureDescriptorAdditionalDatastoreTablesType(_io__raw_descriptor_data, self, self._root)
            else:
    ...
    class DataControlDataSubPacketFormat(KaitaiStruct):
        ...
        def _read(self):
            self.token = KaitaiStream.resolve_enum(TcgStorageBinaryLogParser.DataControlDataSubPacketFormat.TokenEnum, self._io.read_u1())
            _on = self.token
            if _on == TcgStorageBinaryLogParser.DataControlDataSubPacketFormat.TokenEnum.call_token:
                self.data_payload = TcgStorageBinaryLogParser.CallTokenPayload(self._io, self, self._root)
            else:
                self.data_payload = TcgStorageBinaryLogParser.TokenPayload(self._io, self, self._root)
        ...
        def _read(self):
            ...
            if self.payload_length > 0:
                ...
                if _on == 0:
                    ...
                    self.data_sub_packet_payload = TcgStorageBinaryLogParser.DataControlDataSubPacketFormat(_io__raw_data_sub_packet_payload, self, self._root)
                elif _on == 32768:
                    self._raw_data_sub_packet_payload = self._io.read_bytes(self.payload_length)
                    _io__raw_data_sub_packet_payload = KaitaiStream(BytesIO(self._raw_data_sub_packet_payload))
                    self.data_sub_packet_payload = TcgStorageBinaryLogParser.CreditControlDataSubPacketFormat(_io__raw_data_sub_packet_payload, self, self._root)
                else:
    ...
    class Level0DiscoveryResponseData(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.feature_descriptors = TcgStorageBinaryLogParser.FeatureDescriptorListType(_io__raw_feature_descriptors, self, self._root)
